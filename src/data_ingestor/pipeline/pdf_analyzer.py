...
class PDFPreflightResult:
    ...
    def should_use_upscaled(self) -> bool:
        ...
        """
        return self.upscaled_path is not None and self.upscaling_result.get("success", False)
...
class PDFDocumentAnalyzer:
    ...
    def analyze(
        ...
        Returns:
            PDFPreflightResult: Analysis and upscaling results.
        ...
        try:
            resolution_analysis = self.resolution_analyzer.analyze_pdf_resolution(pdf_path)
    ...
    def quick_check(self, pdf_path: str | Path) -> bool:
        ...
        try:
            resolution_analysis = self.resolution_analyzer.analyze_pdf_resolution(pdf_path)
            return resolution_analysis.get("needs_upscaling", False)
        except Exception as e:
