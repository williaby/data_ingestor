...
class TestPDFUpscaler:
    ...
    @patch("data_ingestor.utils.pdf_upscaler.fitz")
    @patch("data_ingestor.utils.pdf_upscaler.cv2")
    @patch("data_ingestor.utils.pdf_upscaler.Image")
    @patch("data_ingestor.utils.pdf_upscaler.Path")
    @patch("data_ingestor.utils.pdf_upscaler.tempfile.NamedTemporaryFile")
...
class TestUpscaleIfNeeded:
    ...
    @patch("data_ingestor.utils.pdf_resolution.quick_resolution_check")
    @patch("data_ingestor.utils.pdf_upscaler.PDFUpscaler")
