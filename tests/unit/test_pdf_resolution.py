...
class TestPDFResolutionAnalyzer:
    ...
    @patch("data_ingestor.utils.pdf_resolution.Path")
    @patch("data_ingestor.utils.pdf_resolution.fitz")
    def test_analyze_pdf_resolution_no_images(self, mock_fitz: Mock, mock_path: Mock) -> None:
    ...
    @patch("data_ingestor.utils.pdf_resolution.Path")
    @patch("data_ingestor.utils.pdf_resolution.fitz")
    def test_analyze_pdf_resolution_high_res(self, mock_fitz: Mock, mock_path: Mock) -> None:
    ...
    @patch("data_ingestor.utils.pdf_resolution.Path")
    @patch("data_ingestor.utils.pdf_resolution.fitz")
    def test_analyze_pdf_resolution_low_res(self, mock_fitz: Mock, mock_path: Mock) -> None:
    ...
    @patch("data_ingestor.utils.pdf_resolution.Path")
    @patch("data_ingestor.utils.pdf_resolution.fitz")
    def test_analyze_pdf_resolution_multiple_pages(self, mock_fitz: Mock, mock_path: Mock) -> None:
    ...
    @patch("data_ingestor.utils.pdf_resolution.Path")
    @patch("data_ingestor.utils.pdf_resolution.fitz")
    def test_analyze_pdf_resolution_zero_bbox(self, mock_fitz: Mock, mock_path: Mock) -> None:
    ...
    @patch("data_ingestor.utils.pdf_resolution.Path")
    @patch("data_ingestor.utils.pdf_resolution.fitz")
    def test_analyze_pdf_resolution_error(self, mock_fitz: Mock, mock_path: Mock) -> None:
...
class TestQuickResolutionCheck:
    ...
    @patch("data_ingestor.utils.pdf_resolution.PDFResolutionAnalyzer")
